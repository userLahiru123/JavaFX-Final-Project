...
public class DashboardFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        labelList.add(lblStaff);
        labelList.add(lblSupplier);
        labelList.add(lblSales);
...
//        borderPane.setCenter(anchorPane);
    ...
    public void lblStaffOnAction() {
        loadPage("staff-page-form");
        changeLabelColor(lblStaff);
    }
    ...
    public void lblSalesOnAction() {
        loadPage("sales-page-form");
        changeLabelColor(lblSales);
    }
